...
static void set_first_line(std::map<int, std::pair<std::string, std::string> >& first_line)
{
	...
	first_line.insert(std::make_pair(200, std::make_pair("OK", "./www/200.html")));
	...
	first_line.insert(std::make_pair(405, std::make_pair("Method Not Allowed", "./www/405.html")));
	...
	first_line.insert(std::make_pair(410, std::make_pair("Gone", "./www/410.html")));
	...
	first_line.insert(std::make_pair(505, std::make_pair("HTTP Version Not Supported", "./www/505.html")));
}
